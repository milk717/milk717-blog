...
![google assistant api 서비스 종료](img.png)
...
~~유지보수 해주세요!~~
![새로운 프로젝트 생성하기](img1.png)_새로운 프로젝트 생성하기_
![http api calls 캡슐 생성](img2.png)_http api calls 캡슐 생성_
...
![빅스비 캡슐 생성 시 초기 상태](img0.png)_빅스비 캡슐 생성 시 초기 상태_
...
![타겟 설정](img_2.png)_타겟 설정_
이 부분을 `target (bixby-mobile-ko-KR)`으로 변경해준다.
그 다음 `Training`에 들어가서 Training Source를 추가해준다.
![한국어 트레이닝 추가하는 방법](img_3.png)_ko-KR Training Source 추가_

### 3-2. 이제 학습시키자!

아래 사진 순서대로 입력을 한다.
![img_4.png](img_4.png)_학습시키기 1_

그럼 아래와 같은 화면이 나온다.
![img_5.png](img_5.png)_학습시키기 2_
...
![img_6.png](img_6.png)_학습시키기 3_
save 버튼을 누른 후 Training 화면을 보면 아직 학습되지 않은 항목이 있다.
![img_7.png](img_7.png)_학습시키기 4_
...
![뷰를 만들기 전 상태](img3.png)_뷰를 만들기 전 상태_
