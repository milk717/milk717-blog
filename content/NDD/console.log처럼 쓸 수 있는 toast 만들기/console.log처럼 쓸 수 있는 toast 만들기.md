...
# 토스트의 구조
![토스트를 console.log처럼 사용하기 위해 eventManger 도입](images/img.png)
...
#### fade-out에서 끊김 현상 발생
![fade-out시 뚝뚝 끊기는 현상 발생](images/gif1.gif)
