...
![이 가설을 세우게 된 스토리😂😂](images/img-9.png)
...
![로그인 구현에 대한 Jira 티켓](images/img-8.png)생각해보면 지금까지 제가 구현했던 로그인은 모두 Authorization 헤더를 사용했었습니다. 때문에 이렇게 쿠키와 브라우저 정책에 대해서 깊게 고민할 필요가 없었죠.
